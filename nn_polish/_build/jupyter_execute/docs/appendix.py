...
# Czytelnik może pobrać notebooki [Jupytera](https://jupyter.org) dla każdego rozdziału, klikając ikonę pobierania (strzałka w dół) po prawej stronie na górnym pasku podczas przeglądania książki. 
# <!-- Alternatywnie, cały zestaw plików można pobrać z
...
# Po zainstalowaniu Pythona i [Jupytera](https://jupyter.org) (najlepiej przez [conda](https://docs.conda.io/projects/conda/en/latest/user-guide/install)), Czytelnik może postępować zgodnie z instrukcjami dla danego systemu operacyjnego, aby otworzyć Jupyter i uruchomić w nim notebooki wykładu. 
